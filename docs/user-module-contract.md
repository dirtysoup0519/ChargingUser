...
本文件同步自逻辑分支的合同，仅同步文档不代表 UI 分支已合入业务代码。UI 分支未收录的参考资料可在逻辑基线查阅：[总体设计与文档目录](https://github.com/dirtysoup0519/ChargingUser/tree/759048a/docs)、[协议资料所在仓库](https://github.com/dirtysoup0519/ChargingUser/tree/759048a)。文中的协议文件及总体设计路径均相对于该逻辑基线。
